            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php $value=( isset($contact) ? $contact->email_for_invoice : ''); ?>
                        <?php echo render_input( 'email_for_invoice', 'Email para facturación',$value, 'email'); ?>
                    ...
                    <!-- AQUI SE AGREGA EL CONTROL PARA SELECCIONAR EL MODO DE PAGO -->
                  <div class="form-group mbot15">
                          <label for="allowed_payment_modes" class="control-label"><?php echo "Formas de pago"; ?></label>
                          <br />
                          <?php if(count($payment_modes) > 0){ ?>
                          <select class="selectpicker" name="allowed_payment_modes[]" multiple="false" data-width="100%" data-title="<?php echo _l('dropdown_non_selected_tex'); ?>">
                          <?php foreach($payment_modes as $mode){
                             $selected = '';
                             if(isset($contact)){
                               if($contact->allowed_payment_modes){
                                $inv_modes = unserialize($contact->allowed_payment_modes);
                    ...
                    <!--  AQUI TERMINA LAS OPCIONES DE METODOS DE PAGO-->
                    ...
                    <div class="client_password_set_wrapper" style="display:none">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" class="form-control password" name="password" autocomplete="false" value="notiene9876">
                ...
                <div class="checkbox checkbox-primary">
                    ...
                    <label for="send_set_password_email" style="display:none">
