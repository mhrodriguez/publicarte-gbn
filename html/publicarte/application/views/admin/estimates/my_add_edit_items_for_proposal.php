...
<div class="table-responsive s_table mtop10">
  <table class="table estimate-items-table items table-main-estimate-edit">
   <thead>
    <tr>
     ...
     <th width="25%" class="text-left"><?php echo 'long_description'; ?></th>
     <?php
 ...
 <tbody>
  ...
  <td>
    <textarea name="long_description" rows="4" class="form-control" placeholder="<?php echo 'Observaciones'; ?>"></textarea>
  </td>
  <td>
