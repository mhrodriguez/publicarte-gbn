...
class __TwigTemplate_49ccb0427a00a31f4e51f14d72981d7390adabdbc0b477b79e1854857fe07ec9 extends Twig_Template
{
    ...
    <table>
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 18
        echo twig_escape_filter($this->env, $this->getAttribute(($context["producto"] ?? null), "descripcion", array()), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Precio</th>
                <td>";
        // line 22
        echo twig_escape_filter($this->env, $this->getAttribute(($context["producto"] ?? null), "precio", array()), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Activo</th>
                <td>";
        // line 26
        if ($this->getAttribute(($context["producto"] ?? null), "activo", array())) {
            echo "Yes";
        } else {
            echo "No";
        }
...
";
    ...
    {
        return new Twig_Source("", ":producto:show.html.twig", "/var/www/html/pospublicarte/app/Resources/views/producto/show.html.twig");
    }
}
