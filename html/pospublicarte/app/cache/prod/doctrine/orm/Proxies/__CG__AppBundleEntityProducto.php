...
class Producto extends \AppBundle\Entity\Producto implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Producto' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Producto' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Producto' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\Producto' . "\0" . 'precio', '' . "\0" . 'AppBundle\\Entity\\Producto' . "\0" . 'moneda', '' . "\0" . 'AppBundle\\Entity\\Producto' . "\0" . 'activo');
        }
