 ...
 */
class Sucursal extends \AppBundle\Entity\Sucursal implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Sucursal' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Sucursal' . "\0" . 'empresa', '' . "\0" . 'AppBundle\\Entity\\Sucursal' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Sucursal' . "\0" . 'secciones', '' . "\0" . 'AppBundle\\Entity\\Sucursal' . "\0" . 'cp', '' . "\0" . 'AppBundle\\Entity\\Sucursal' . "\0" . 'token', '' . "\0" . 'AppBundle\\Entity\\Sucursal' . "\0" . 'activo');
        }
    ...
    public function addSeccion(\AppBundle\Entity\Seccion $secciones)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addSeccion', array($secciones));

        return parent::addSeccion($secciones);
    }
    ...
    public function removeSeccion(\AppBundle\Entity\Seccion $secciones)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeSeccion', array($secciones));

        return parent::removeSeccion($secciones);
    }
