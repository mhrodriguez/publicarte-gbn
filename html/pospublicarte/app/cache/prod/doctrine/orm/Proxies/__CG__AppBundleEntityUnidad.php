 ...
 */
class Unidad extends \AppBundle\Entity\Unidad implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Unidad' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Unidad' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Unidad' . "\0" . 'satclaveunidad', '' . "\0" . 'AppBundle\\Entity\\Unidad' . "\0" . 'activo');
        }
