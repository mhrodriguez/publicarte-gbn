 ...
 */
class Subcategoria extends \AppBundle\Entity\Subcategoria implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Subcategoria' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Subcategoria' . "\0" . 'categoria', '' . "\0" . 'AppBundle\\Entity\\Subcategoria' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Subcategoria' . "\0" . 'activo');
        }
