 ...
 */
class Seccion extends \AppBundle\Entity\Seccion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Seccion' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Seccion' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Seccion' . "\0" . 'version', '' . "\0" . 'AppBundle\\Entity\\Seccion' . "\0" . 'activo');
        }
