...
class Empresa extends \AppBundle\Entity\Empresa implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Empresa' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Empresa' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Empresa' . "\0" . 'rfc', '' . "\0" . 'AppBundle\\Entity\\Empresa' . "\0" . 'alias', '' . "\0" . 'AppBundle\\Entity\\Empresa' . "\0" . 'tipo', '' . "\0" . 'AppBundle\\Entity\\Empresa' . "\0" . 'logo', '' . "\0" . 'AppBundle\\Entity\\Empresa' . "\0" . 'telefono', '' . "\0" . 'AppBundle\\Entity\\Empresa' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\Empresa' . "\0" . 'activo');
        }
