 ...
 */
class Maquina extends \AppBundle\Entity\Maquina implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Maquina' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Maquina' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Maquina' . "\0" . 'activo');
        }
