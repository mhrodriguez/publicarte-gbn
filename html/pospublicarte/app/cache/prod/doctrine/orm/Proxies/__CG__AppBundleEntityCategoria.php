...
class Categoria extends \AppBundle\Entity\Categoria implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Categoria' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Categoria' . "\0" . 'empresa', '' . "\0" . 'AppBundle\\Entity\\Categoria' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Categoria' . "\0" . 'activo');
        }
