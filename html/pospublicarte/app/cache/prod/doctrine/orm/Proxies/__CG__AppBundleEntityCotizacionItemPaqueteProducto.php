 ...
 */
class CotizacionItemPaqueteProducto extends \AppBundle\Entity\CotizacionItemPaqueteProducto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CotizacionItemPaqueteProducto' . "\0" . 'id', 'producto', 'cantidad', '' . "\0" . 'AppBundle\\Entity\\CotizacionItemPaqueteProducto' . "\0" . 'fecha', '' . "\0" . 'AppBundle\\Entity\\CotizacionItemPaqueteProducto' . "\0" . 'activo');
        }

        return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CotizacionItemPaqueteProducto' . "\0" . 'id', 'cantidad', '' . "\0" . 'AppBundle\\Entity\\CotizacionItemPaqueteProducto' . "\0" . 'fecha', '' . "\0" . 'AppBundle\\Entity\\CotizacionItemPaqueteProducto' . "\0" . 'activo');
    }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CotizacionItemPaqueteProducto $proxy) {
