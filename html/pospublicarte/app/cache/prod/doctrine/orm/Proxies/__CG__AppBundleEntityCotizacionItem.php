 ...
 */
class CotizacionItem extends \AppBundle\Entity\CotizacionItem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CotizacionItem' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\CotizacionItem' . "\0" . 'producto', '' . "\0" . 'AppBundle\\Entity\\CotizacionItem' . "\0" . 'descripcion', 'precio', 'cantidad', 'total', '' . "\0" . 'AppBundle\\Entity\\CotizacionItem' . "\0" . 'moneda', '' . "\0" . 'AppBundle\\Entity\\CotizacionItem' . "\0" . 'fecha', '' . "\0" . 'AppBundle\\Entity\\CotizacionItem' . "\0" . 'activo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CotizacionItem $proxy) {
