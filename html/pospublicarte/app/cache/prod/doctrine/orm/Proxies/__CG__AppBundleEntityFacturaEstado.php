 ...
 */
class FacturaEstado extends \AppBundle\Entity\FacturaEstado implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\FacturaEstado' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\FacturaEstado' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\FacturaEstado' . "\0" . 'activo');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FacturaEstado $proxy) {
